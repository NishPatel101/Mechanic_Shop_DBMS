...
FROM '/tmp/jvo033/csv_data/customer.csv'
WITH DELIMITER ',';
...
FROM '/tmp/jvo033/csv_data/mechanic.csv'
WITH DELIMITER ',';
...
FROM '/tmp/jvo033/csv_data/car.csv'
WITH DELIMITER ',';
...
FROM '/tmp/jvo033/csv_data/owns.csv'
WITH DELIMITER ',';
...
FROM '/tmp/jvo033/csv_data/service_request.csv'
WITH DELIMITER ',';
...
FROM '/tmp/jvo033/csv_data/closed_request.csv'
WITH DELIMITER ',';
