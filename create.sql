...
FROM '/tmp/jvo033/data/customer.csv'
WITH DELIMITER ',';
...
FROM '/tmp/jvo033/data/mechanic.csv'
WITH DELIMITER ',';
...
FROM '/tmp/jvo033/data/service_request.csv'
WITH DELIMITER ',';
...
FROM '/tmp/jvo033/data/closed_request.csv'
WITH DELIMITER ',';
